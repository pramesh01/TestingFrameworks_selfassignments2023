...
public class Constant {
	...
	public static final By loginLink_locator=By.xpath(loginLink);
			...
			public static final String submitButton="//*[@id='password']";
			public static final  By submitButton_locator=By.xpath(submitButton);
			...
			public static final By HomePageText_Locator=By.xpath(HOMEPAGETEXT);
			
			//title
			public static final String HomePageTitle="Zoho - Cloud Software Suite and SaaS Applications";
//reports
